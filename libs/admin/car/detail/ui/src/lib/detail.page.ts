...
export class DetailPage {
  ...
  readonly selectedCar$ = this.store.select(CarState.selectedCar);
  ...
  constructor(
    ...
    this.state.hold(this.selectedCar$.pipe(filter((car) => !!car)), (car) => {
      this.form.patchValue({ isAvailable: car?.isAvailable });
    });
  }
}
